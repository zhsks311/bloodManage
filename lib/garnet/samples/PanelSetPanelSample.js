enyo.kind({
	...
	components: [
		...
		{content: "depth-transition g.PanelSet", classes: "g-sample-subheader"},
		{
			...
			components: [
				{
					kind: "g.PanelSet",
					components: [
						{kind: "g.Panel", name: "p3", components: [
		...
		{content: "move-transition g.PanelSet", classes: "g-sample-subheader"},
		{
			style: "width: 320px; height: 320px; position: relative; display: inline-block; margin-right: 20px;",
			components: [
				{
					...
					pageIndicator: true,
					components: [
						{kind: "g.Panel", pageIndicatorFadeOut: false, name: "p3", components: [
			...
			components: [
				{
					kind: "g.Panel",
					components: [
						{kind: "g.PanelSet", effect: "move-transition", pageIndicator: true, components: [

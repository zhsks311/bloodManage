enyo.kind({
	...
	components: [
		...
		{content: "move-transition g.PanelSet in depth-transition g.PanelSet", classes: "g-sample-subheader"},
		{
			...
			components: [
				{
					kind: "g.Panel",
					components: [
						{name: "panelSetC", kind: "g.PanelSet", components: [
							{kind: "g.PanelSet", pageIndicator: true, effect: "move-transition", components: [

enyo.kind({
	...
	components: [
		...
		{content: "move-transition g.PanelSet in move-transition g.PanelSet", classes: "g-sample-subheader"},
		{
			style: "width: 320px; height: 320px; position: relative; display: inline-block; margin-right: 20px;",
			components: [
				{
					name: "panelSetA",
					kind: "g.PanelSet",
					...
					pageIndicator: true,
					components: [
						{kind: "g.PanelSet", pageIndicator: true, effect: "move-transition", components: [
			...
			components: [
				{
					...
					pageIndicator: true,
					components: [
						{kind: "g.Panel", pageIndicatorFadeOut: false, components: [
							{kind: "g.PanelSet", pageIndicator: true, effect: "move-transition", components: [
						...
						{king: "g.Panel", pageIndicatorFadeOut: false, components: [
							{kind: "g.PanelSet", pageIndicator: true, effect: "move-transition", components: [
			...
			components: [
				{
					kind: "g.Panel",
					components: [
						{name: "panelSetC", kind: "g.PanelSet", effect: "move-transition", pageIndicator: true, components: [
							{kind: "g.PanelSet", pageIndicator: true, effect: "move-transition", components: [

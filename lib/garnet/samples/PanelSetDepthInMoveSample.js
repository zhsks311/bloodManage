enyo.kind({
	...
	components: [
		...
		{content: "depth-transition g.PanelSet in move-transition g.PanelSet", classes: "g-sample-subheader"},
		{
			...
			components: [
				{
					kind: "g.Panel",
					components: [
						{name: "panelSetC", kind: "g.PanelSet", pageIndicator: true, effect: "move-transition", components: [
							{kind: "g.PanelSet", components: [
